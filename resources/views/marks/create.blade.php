        ...
        <div class="row">
            ...
            <div class="col-xl-6 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('marks.store') }}" autocomplete="off">
                            @csrf

                            <h6 class="heading-small text-muted mb-4">{{ __('Add Mark List') }}</h6>
                            <div class="pl-lg-0">
                                ...
                                <div class="form-group{{ $errors->has('mark_in_maths') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mark_in_maths" id="input-mark_in_maths" class="form-control form-control-alternative{{ $errors->has('mark_in_maths') ? ' is-invalid' : '' }}" placeholder="{{ __('Mark') }}" value="{{ old('mark_in_maths') }}" >
                                ...
                                <div class="form-group{{ $errors->has('mark_in_science') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mark_in_science" id="input-mark_in_science" class="form-control form-control-alternative{{ $errors->has('mark_in_science') ? ' is-invalid' : '' }}" placeholder="{{ __('Mark') }}" value="{{ old('mark_in_science') }}" >
                                ...
                                <div class="form-group{{ $errors->has('mark_in_history') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="mark_in_history" id="input-mark_in_history" class="form-control form-control-alternative{{ $errors->has('mark_in_history') ? ' is-invalid' : '' }}" placeholder="{{ __('Mark') }}" value="{{ old('mark_in_history') }}" >
